package com.alachao.study.thread.executorService;
...
public class ThreadPoolManager {
    ...
    // 线程池维护线程的最少数量  Runtime.getRuntime.availableProcessors;
    ...
    // 线程池所使用的缓冲队列大小
    private static final int SIZE_WORK_QUEUE = 4500;
